...
# ===== 多 Tab 信息架构 =====
tab_overview, tab_correlation, tab_pairs, tab_ai = st.tabs([
    "📊 Overview",
    "🔥 Correlation",
    "🎯 Pairs Trading",
    "🤖 AI Analysis"
...
with tab_correlation:
    ...
    st.caption("Daily-return correlation. Red = positive, Blue = negative.")
    ...
    if len(all_data.columns) >= 2:
        ...
        st.info("Select 2+ assets in the sidebar")
...
with tab_pairs:
    ...
    if len(all_data.columns) >= 2:
        ...
        st.info("Select 2+ assets in the sidebar to enable pairs analysis")
